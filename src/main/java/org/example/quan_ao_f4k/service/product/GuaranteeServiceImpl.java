...
public class GuaranteeServiceImpl implements GuaranteeService{
    ...
    public void exportExcel(HttpServletResponse response) throws Exception {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=DanhSachBaoHanh.xlsx");
        ...
        cell.setCellValue("Tên thương hiệu");
        cell.setCellStyle(headerStyle);
    ...
    public void exportPdf(HttpServletResponse response) throws Exception {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=DanhSachBaoHanh.pdf");
        ...
        // Đường dẫn đến font Roboto-Regular trên máy của bạn
