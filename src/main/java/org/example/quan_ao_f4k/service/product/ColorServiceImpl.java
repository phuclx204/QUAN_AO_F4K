...
public class ColorServiceImpl implements ColorService{
    private ColorMapper brandMapper;
    private ColorRepository brandRepository;

    @Override
    public ListResponse<ColorResponse> findAll(int page, int size, String sort, String filter, String search, boolean all) {
        return defaultFindAll(page, size, sort, filter, search, all, SearchFields.COLOR, brandRepository, brandMapper);
    ...
    public void updateStatus(Long id, int status) {
        Color brand = brandRepository.findById(id)
    ...
    public void exportExcel(HttpServletResponse response) throws Exception {
        List<Color> brands = brandRepository.findAll();
